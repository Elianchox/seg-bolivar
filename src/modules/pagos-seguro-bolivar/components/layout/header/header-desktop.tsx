import { bottomNav, topLinks } from "@pagos/constants/nav";
import { ContactDropdown } from "@pagos/components/layout/header/contact-dropdown";
...
import { IconLogo } from "@pagos/components/ui/icons/icon-logo";
