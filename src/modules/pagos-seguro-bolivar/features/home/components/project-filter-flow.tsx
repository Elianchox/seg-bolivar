...
import { SectionHeading } from "@pagos/features/home/components/section-heading";
import { Spacer } from "@pagos/components/ui/spacer";
import { IconArrowBottom } from "@pagos/components/ui/icons/icon-arrow-bottom";
import { IconArrowFilter } from "@pagos/components/ui/icons/icon-arrow-filter";
import { IconFilterCity } from "@pagos/components/ui/icons/icon-filter-city";
import { IconFilterPrice } from "@pagos/components/ui/icons/icon-filter-price";
import { IconFilterType } from "@pagos/components/ui/icons/icon-filter-type";
import {
  classificationOptions,
  locationOptions,
  projectTypeOptions,
  typeOptions,
} from "@pagos/features/home/data/filter-options";
import type { FilterOption } from "@pagos/features/home/data/filter-options";
