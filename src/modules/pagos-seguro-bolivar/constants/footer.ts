...
import { IconFacebook } from "@pagos/components/ui/icons/icon-facebook";
import { IconInstagram } from "@pagos/components/ui/icons/icon-instagram";
import { IconLinkedin } from "@pagos/components/ui/icons/icon-linkedin";
import { IconTiktok } from "@pagos/components/ui/icons/icon-tiktok";
import { IconYoutube } from "@pagos/components/ui/icons/icon-youtube";
