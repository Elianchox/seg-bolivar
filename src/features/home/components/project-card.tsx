...
import { IconArea } from "@/components/ui/icons/icon-area";
import { IconArrowRight } from "@/components/ui/icons/icon-arrow-right";
import { IconBath } from "@/components/ui/icons/icon-bath";
import { IconBed } from "@/components/ui/icons/icon-bed";
import { IconLivingRoom } from "@/components/ui/icons/icon-living-room";
import { IconMessage } from "@/components/ui/icons/icon-message";
import { Spacer } from "@/components/ui/spacer";
import type { HomeProject } from "@/features/home/data/projects";
