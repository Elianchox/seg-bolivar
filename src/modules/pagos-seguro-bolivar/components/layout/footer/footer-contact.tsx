...
import { IconChat } from "@pagos/components/ui/icons/icon-chat";
import { IconMail } from "@pagos/components/ui/icons/icon-mail";
...
import { IconPhone } from "@pagos/components/ui/icons/icon-phone";
